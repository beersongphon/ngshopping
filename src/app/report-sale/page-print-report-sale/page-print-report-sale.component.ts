...
@Component({
  selector: 'app-page-print-report-sale',
  templateUrl: './page-print-report-sale.component.html',
  styleUrls: ['./page-print-report-sale.component.css']
})
export class PagePrintReportSaleComponent implements OnInit {
